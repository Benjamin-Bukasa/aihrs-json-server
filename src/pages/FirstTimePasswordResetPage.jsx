...
function FirstTimePasswordResetPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`http://10.5.0.26:5000/users?username=${user.username}`);
      ...
      if (response.data.length > 0) {
        ...
        const putResponse = await axios.put(`http://10.5.0.26:5000/users/${fetchedUser.id}`, updatedUser);
