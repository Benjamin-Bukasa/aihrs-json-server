      ...
      <div className="w-full bg-white">
        ...
        <div className="w-full rounded-xl p-2 divide-y">
          <ul className="w-full flex justify-center divide-x ">
            ...
            <Link to={`/${user.name}/pointage`} className='flex justify-start items-center gap-2 px-10 py-2 text-slate-400 hover:text-slate-600'><li className="font-medium active:text-orange-500 text-[14px]">Pointage</li></Link>
