    ...
    { name: "Date d'affectation" },
    {
      ...
      options: {
        customBodyRender: (value) => (
          <p className=''>
            {value === true ? <span className='bg-green-400 text-white px-4 py-1 rounded-xl'>Actif</span> : <span className='bg-red-400 text-white px-4 py-1 rounded-xl'>inactif</span>}
          </p>
        )
      }
    },
